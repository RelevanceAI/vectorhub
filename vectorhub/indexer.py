...
class ViIndexer:
    def request_api_key(self, username, email, referral=None):
        """
    ...
    def _create_document(self, _id, item, metadata=None):
        return {
            '_id': str(_id),
            'item': item,
            'metadata': metadata
    ...
    def search(self, item, num_results: int=10):
        """
    ...
    def retrieve_documents(self, num_of_documents):
        """
